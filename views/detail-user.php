                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body"> 
                                ...
                                <div class="mt-3">
                                    <a href="list-user.php" class="btn btn-secondary"><i class=
                                    "fas fa-arrow-left"></i> Back</a>
                                    <a href="edit-user.php?id"=<?= $user['id'] ?>" class="btn btn-warning"><i class=
                                    "fas fa-edit"></i> Edit</a>
                                    <a href="delete-user.php?id"=<?= $user['id'] ?>" class="btn btn-danger"><i class=

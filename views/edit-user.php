                            ...
                            <div class="card-body"> 
                                  <form action="edit-user.php?id=<?= $user['id'] ?>" "method="POST">
                                    <div class="mb-3">
                                        ...
                                        name="firstname" value="<?= $user['fisrtname'] ?>" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inLine">
                                            ...
                                            name="gender" value="Laki-laki" <?= $user['gender'] === 'Laki-laki' ? 'checked' : '' ?>> id="laki-laki"
                                            class="form-check-label">laki-laki</label>
                                    </div>
                                    <div class="form-check form-check-inLine">
                                            <input type="radio" class="form-check-input"
                                            name="gender" value="perempuan" <?= $user['gender'] === 'Perempuan' ? 'checked' : '' ?>> id="perempuan"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        min="0" max="100" name="age" value="<?= $user['age'] ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="weight" class="form-label">Weight</label>
                                        <input type="number" class="form-control" id="weight"
                                        min="0" max="100" name="weight" value="<?= $user['weight'] ?>" required>
                                    </div>

                                    <a href="List-user.php" class="btn btn-secondary"><i 

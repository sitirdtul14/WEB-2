            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-3 fw-bold">Kode Produk</div>
                                <div class="col-md-9">{{ $produk->kode }}</div>

                                <div class="col-md-3 fw-bold">Nama Produk</div>
                                <div class="col-md-9">{{ $produk->nama }}</div>

                                <div class="col-md-3 fw-bold">Jenis Produk</div>
                                <div class="col-md-9">{{ $produk->jenisProduk->nama }}</div>

                                <div class="col-md-3 fw-bold">Harga</div>
                                <div class="col-md-9">Rp {{ number_format($produk->harga, 2) }}</div>

                                <div class="col-md-3 fw-bold">Stok Tersedia</div>
                            ...
                            @if($produk->detailPesanan->count() > 0)
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @foreach($produk->detailPesanan as $detail)
                                                <tr>
                                                    <td>#{{ $detail->pesanan->id }}</td>
                                                    <td>{{ $detail->pesanan->tanggal->format('d/m/Y') }}</td>
                                                    <td>{{ $detail->pesanan->anggota->pegawai->nama }}</td>
                                                    <td>{{ $detail->jumlah }}</td>
                                                    <td>Rp {{ number_format($detail->jumlah * $produk->harga, 2) }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                            ...
                            @else
                                <div class="alert alert-info">
                                    Produk ini belum pernah dipesan.
                                </div>
                            @endif

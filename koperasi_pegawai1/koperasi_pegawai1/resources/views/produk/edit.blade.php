                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('produk.update', $produk->id) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('jenis_produk_id') is-invalid @enderror"
                                        id="jenis_produk_id" name="jenis_produk_id" required>
                                        <option value="">Pilih Jenis Produk</option>
                                        @foreach($jenisProduk as $jp)
                                            <option value="{{ $jp->id }}" {{ (old('jenis_produk_id', $produk->jenis_produk_id) == $jp->id) ? 'selected' : '' }}>
                                                {{ $jp->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('harga') is-invalid @enderror"
                                        id="harga" name="harga" step="0.01" value="{{ old('harga', $produk->harga) }}"
                                        required>
                                    @error('harga')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror

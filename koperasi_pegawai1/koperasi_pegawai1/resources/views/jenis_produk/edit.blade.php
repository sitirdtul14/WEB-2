                ...
                <div class="container-fluid px-4">
                    <div class="card mt-4">
                        <div class="card-header">
                            <h5>Edit Jenis Produk: {{ $jenisProduk->nama }}</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('jenis-produk.update', $jenisProduk->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama Jenis Produk <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" value="{{ old('nama', $jenisProduk->nama) }}" required>
                                    @error('nama')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                        ...
                                        rows="3">{{ old('deskripsi', $jenisProduk->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>

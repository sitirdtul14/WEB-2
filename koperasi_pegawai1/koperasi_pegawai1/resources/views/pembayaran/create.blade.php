...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="container mt-4">
                        <h1 class="mb-4">Tambah Pembayaran Baru</h1>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('pembayaran.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label for="jumlah_bayar" class="form-label">Jumlah Harga</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="pesanan_id" name="pesanan_id" required>
                                            ...
                                            @foreach($pesanan as $item)
                                                ...
                                                @endphp
                                                <option value="{{ $item->id }}" data-jumlah-harga="{{ $total }}">
    ...
    <script>
        document.getElementById('pesanan_id').addEventListener('change', function () {
            ...
            var jumlahHarga = selectedOption.getAttribute('data-jumlah-harga');
            document.getElementById('jumlah_bayar').value = jumlahHarga;
        });
    </script>
</body>
